...
export default function InfosPublic() {
  ...
  <div className="flex flex-col  w-full max-w-300 px-4 md:px-0">
    ...
    <h2 className="text-4xl md:text-6xl font-bold text-white uppercase text-center pb-6 items-center">
      INFOS <span className="text-[#F6339A]">PRATIQUES</span>
    </h2>

<h3 className="text-4xl md:text-5xl font-bold text-white uppercase text-left pt-40pb-6 flex items-center gap-4">
...
<div className="w-full grid grid-cols-1 md:grid-cols-2 text-white text-left text-base uppercase pl-15 pt-20">
  ...
  <div className="flex items-start gap-6">
    ...
    <div className="
      ...
      bg-white/10
    ">
      <svg height="50" width="50" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="pt-2 pl-6">
      ...
      <p className="text-white text-base uppercase pl-4 pt-4">
...
<div className="w-full grid grid-cols-1 md:grid-cols-2 text-white text-left text-base uppercase pl-15 pt-15">
  ...
  <div className="flex items-start gap-6">
    ...
    <div className="
      ...
      bg-white/10
    ">
      <svg height="40" width="40" viewBox="0 0 384 384" xmlns="http://www.w3.org/2000/svg">
