...
//         <button 
//           onClick={() => setShowCreateModal(true)}
//           className="px-3 py-1.5 text-xs sm:text-sm bg-gradient-to-r from-blue-600/30 to-blue-700/30 text-blue-200 border border-blue-500/30 rounded-lg hover:from-blue-700/40 hover:to-blue-800/40 hover:text-white hover:scale-[1.02] transition-all duration-200 shadow hover:shadow-blue-500/20 w-full sm:w-auto"
//         >
//           + Nouvel utilisateur
//         </button>
//       </div>
...
//         ) : (
//           <tr>
//             <td colSpan="5" className="px-3 sm:px-6 py-3 text-center text-gray-400 text-xs sm:text-sm">
//               Aucun utilisateur trouvé
//             </td>
//           </tr>
//         )}
