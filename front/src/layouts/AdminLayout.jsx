    ...
    <div className="flex h-screen bg-linear-to-br from-[#0a0c0f] to-[#0d0f12] text-white overflow-hidden">
      ...
      <aside
        className={`
          ...
          bg-linear-to-b from-[#111318]/90 to-[#0c0e11]/90
          backdrop-blur-xl
      ...
      >
        ...
        <div className="p-5 border-b border-white/10">
          ...
          >
            ...
            <div className="relative group/avatar">
              ...
              <div className="relative w-12 h-12 rounded-full bg-linear-to-br from-blue-600/30 to-purple-600/30 border-2 border-white/20 flex items-center justify-center font-bold shadow-lg shadow-blue-500/20 backdrop-blur-sm">
        ...
        <div className="p-4 border-t border-white/10">
          {isSidebarOpen ? (
            <div className="group relative bg-linear-to-brrom-white/[0.07] to-white/2drop-blur-2xl border border-white/10 rounded-xl p-4 shadow-xl shadow-black/30 hover:border-blue-500/30 transition-all duration-300 overflow-hidden">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Header */}
        <header className="bg-linear-to-r from-[#111318]/80 to-[#0f1116]/80 backdrop-blur-xl border-b border-white/10 px-6 py-3 flex items-center justify-between shadow-xl shadow-black/20">
    ...
    {isSidebarOpen ? "☰" : "✕"}
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="group relative w-9 h-9 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-200 flex items-center justify-center overflow-hidden">
              <div className="absolute inset-0 bg-linear-to-rrom-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700" />
        ...
        {/* Page Content */}
        <div className="flex-1 overflow-y-auto bg-linear-to-b from-[#0a0c0f] via-[#0c0e11] to-[#0d0f12] p-6 scrollbar-thin-dark">
          <Outlet />
        </div>
      </main>
    </div>
