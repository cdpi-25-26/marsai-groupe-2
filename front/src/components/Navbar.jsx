...
export default function Navbar() {
  ...
  return (
    <div className="group fixed top-4 left-1/2 -translate-x-1/2 w-[75%] max-w-6xl z-50">
      {/* Effet de halo lumineux autour de la navbar */}
      <div className="absolute -inset-1 bg-gradient-to-r from-blue-600/30 via-purple-600/30 to-pink-600/30 rounded-full blur-xl opacity-50 group-hover:opacity-75 transition duration-1000" />
      
      {/* Navbar principale avec effet liquid glass */}
      <div
        className="relative backdrop-blur-md bg-transparent 
        ...
        <Link to="/" className="relative z-10">
          <div className="flex items-center gap-2">
            <span className="text-xl font-bold tracking-wide text-white/90">Mars</span>
            <span
          ...
          <div className="relative group/lang">
            <Link
              ...
              <svg
                ...
                viewBox="0 0 512 512"
                xmlns="http://www.w3.org/2000/svg"
                className="group-hover/lang:scale-105 transition-transform">
            ...
            {/* Tooltip pour la langue avec effet liquid glass */}
