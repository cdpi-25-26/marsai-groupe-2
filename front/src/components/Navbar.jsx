  ...
  return (
    <div className="flex mt-0 ml-2.5 mr-2.5 bg-black/30 text-white text-xl uppercase rounded-full justify-between items-center p-1 border-white/30 border-2 fixed top-8 left-0 right-0 z-50">
      ...
      <div className=" flex gap-6 items-center font-bold">
        {/* home */}
        <Link to="/" className="mr-4 hover:text-[#F6339A]"><svg height="30" width="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
{/* agenda */}
        <Link to="/" className="mr-4 hover:text-[#F6339A]"><svg height="20" width="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
{/* jury*/}
<Link to="/" className="mr-4 hover:text-[#F6339A]"><svg height="30" width="30" viewBox="0 0 17 16" xmlns="http://www.w3.org/2000/svg">
...
{/* sponsors */}
        <Link to="/" className="mr-4 hover:text-[#F6339A]"><svg height="30" width="30" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
