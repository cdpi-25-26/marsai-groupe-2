...
export default function Program() {
    ...
    <div>
    <h2 className="ml-6 pl-20 text-6xl font-bold text-white uppercase pb-6">MARS.A.I</h2> 
    <h2 className="ml-6 pl-20 text-6xl font-bold  text-[#F6339A] uppercase pb-6">night</h2>
    <p className="ml-6 pl-20 text-2xl text-white">Fête Électro mêlant IA et futurs souhaitables.<br/> Une expérience immersive sonore et visuelle.</p>
    </div>
    <div>
<OneCard 
    icon={<svg height="200" width="200" viewBox="0 0 432 432" xmlns="http://www.w3.org/2000/svg">
	<path d="M213.5 3q88.5 0 151 62.5T427 216t-62.5 150.5t-151 62.5t-151-62.5T0 216T62.5 65.5T213.5 3zm0 384q70.5 0 120.5-50t50-121t-50-121t-120.5-50T93 95T43 216t50 121t120.5 50zM224 109v112l96 57l-16 27l-112-68V109h32z" fill="currentColor"/>
</svg>}
          title="13 JUIN 2026"
