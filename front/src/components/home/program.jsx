...
<h2 className="text-6xl font-bold text-center text-white uppercase pb-6">DEUX JOURNÉES DE <span className="text-[#F6339A]">CONFÉRENCES gratuites</span> </h2>
        </div>
<div className="ml-6 pl-20 text-2xl pb-3.5">
        <TitleInBox icon = {<svg height="20" width="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
