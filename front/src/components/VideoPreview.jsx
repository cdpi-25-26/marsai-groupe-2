    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4">
          <div className="relative w-full max-w-5xl mx-2 sm:mx-4">
            {/* Header */}
            ...
            <div className="relative rounded-lg overflow-hidden border border-white/10 bg-black shadow-2xl shadow-black/50">
              <video
                ref={videoRef}
                className="w-full h-auto max-h-[50vh] sm:max-h-[60vh] md:max-h-[70vh]"
                src={src}
                poster={poster || undefined}
                controls
                autoPlay
            ...
            <div className="mt-2 sm:mt-4 flex justify-end">
              <button
                onClick={requestNativeFullscreen}
                className="px-3 sm:px-4 py-1.5 sm:py-2 bg-white/10 text-white text-[10px] sm:text-xs font-medium rounded-lg hover:bg-white/20 transition-colors border border-white/20 flex items-center gap-1.5 sm:gap-2"
              >
