...
const mediasDir = path.join(uploadDir, "medias");
...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    // Keep movie files under uploads/medias; other assets stay in uploads.
    if (file.fieldname === "filmFile") return cb(null, mediasDir);
